...
$(function () {
    ...
    if (!$.app.menu.is_touch_device()) {
        ...
        if (todoNewTasksidebar.length > 0) {
            var todo_new_task_sidebar = new PerfectScrollbar(
    ...
    addTodo.on("click", function () {
        ...
        if (taskTitle.val().length > 0) {
            ...
            var avatarSRC = todoTaskListWrapper
                .find("[data-name='" + selectAssign + "']")
                .find(".avatar img")
                .attr("src"); //Img src find if data name matches with list
            todoTaskListWrapper.append(
                ...
                '<li class="todo-item" data-name="' +
                    ...
                    '<i class="ft-star"></i>' +
                    "</a>" +
                    '<a class="todo-item-delete ml-50">' +
    ...
    $(".close-icon, .cancel-btn, .app-content-overlay, .mark-complete-btn").on(
        "click",
        function () {
            todoNewTasksidebar.removeClass("show");
            appContentOverlay.removeClass("show");
    ...
    todoTaskListWrapper.on(
        "click",
        ".todo-item .custom-control-input",
        function (e) {
    ...
    $(".ascending").on("click", function () {
        ...
        function sort_li(a, b) {
            return $(b).find(".todo-title").text() <
                $(a).find(".todo-title").text()
                ? 1
                : -1;
        }
    });
