...
$(function () {
    ...
    new Quill(".snow-container .compose-editor", {
        ...
        new Quill(".snow-container .comment-editor", {
            modules: { toolbar: ".comment-quill-toolbar" },
    ...
    $(".menu-toggle").on("click", function () {
                ...
                todoTaskListWrapper.append(
                    '<li class="todo-item" data-name="' +
                        ...
                        (void 0 !== (l = i)
                            ...
                            : '<div class="avatar-content"><i class="ft-user font-medium-4"></i></div>') +
        ...
        $(
            ".close-icon, .cancel-btn, .app-content-overlay, .mark-complete-btn"
        ).on("click", function () {
            todoNewTasksidebar.removeClass("show"),
                appContentOverlay.removeClass("show"),
                setTimeout(function () {
            ...
            "" != e
                ? (todoItem.filter(function () {
                  ...
                  0 == $(".todo-item:visible").length
                      ? noResults.hasClass("show") || noResults.addClass("show")
                      : noResults.removeClass("show"))
                : (todoItem.show(),
                  noResults.hasClass("show") && noResults.removeClass("show"));
        });
    var e = "";
    todoTaskListWrapper
        .on("click", ".todo-item", function (t) {
            ...
            if (
                ($(".select2-users-name").val(n).trigger("change"),
                $(this).find(".badge").length)
            ) {
                var i = [];
                $(this)
                    .find(".badge")
        ...
        markCompleteBtn.on("click", function () {
            e.addClass("completed"),
                e.find(".custom-control-input").prop("checked", !0),
                selectAssignLable.attr("disabled", "true");
        }),
        ...
        $(".ascending").on("click", function () {
            (todoItem = $(".todo-item")),
                ...
                todoItem
                    .sort(function (e, t) {
                        return $(t).find(".todo-title").text() <
                            $(e).find(".todo-title").text()
                            ? 1
                            : -1;
                    })
    ...
    $(window).on("resize", function () {
        $(window).width() > 992 &&
            appContentOverlay.hasClass("show") &&
            (sideBarLeft.removeClass("show"),
            appContentOverlay.removeClass("show"),
            todoNewTasksidebar.removeClass("show"));
    });
