...
function chatMessagesSend(a) {
    ...
    if ("" != e) {
        var t =
            ...
            e +
            "</p><div class=chat-time>3:35 AM</div></div>";
        $(".chat-wrapper .chat:last-child .chat-body").append(t),
            chatMessageSend.val(""),
            chatContainer.scrollTop(
                $(".chat-container > .chat-content").height()
            );
    }
}
    ...
    chatSidebarProfileToggle.on("click", function () {
        ...
        chatProfileClose.on("click", function () {
            chatUserProfile.removeClass("show"),
                ...
                chatSidebar.hasClass("show") || chatOverlay.removeClass("show");
        }),
        ...
        $(".chat-sidebar-list-wrapper ul li").on("click", function () {
            $(".chat-sidebar-list-wrapper ul li").hasClass("active") &&
        ...
        $("#chat-search").on("keyup", function () {
            ...
            "" != a
                ? $(".chat-sidebar-list-wrapper .chat-sidebar-list li").filter(
                      function () {
                          $(this).toggle(
                              $(this).text().toLowerCase().indexOf(a) > -1
                          );
                      }
                  )
