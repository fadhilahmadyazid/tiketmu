$(function () {
    ...
    if ($.app.menu.is_touch_device())
        ...
        if (n.length > 0)
            new PerfectScrollbar(".email-user-list", { wheelPropagation: !1 });
    ...
    var c = new Quill(".snow-container .detail-view-editor", {
        modules: { toolbar: ".detail-quill-toolbar" },
    ...
    $(".mail-reply").on("click", function () {
        ...
        $(".menu-toggle").on("click", function (o) {
            e.find(".sidebar-left").removeClass("show"),
                s.removeClass("show"),
                a.removeClass("show");
        }),
        ...
        i
            .find(".list-group-messages a,.list-group-labels a")
            .on("click", function () {
                var e = $(this);
                i
                    .find(".list-group-messages a,.list-group-labels a")
        ...
        $(".go-back, #inbox-menu").on("click", function (e) {
            e.stopPropagation(),
                l.removeClass("show"),
                ($(".detail-view-editor .ql-editor")[0].innerHTML = "");
        }),
        i.find(".favorite i").on("click", function (e) {
            ...
            s.parent(".favorite").toggleClass("warning"),
                s.hasClass("bx-star")
                    ? (s.addClass("bxs-star"), s.removeClass("bx-star"))
                    : (s.addClass("bx-star"), s.removeClass("bxs-star"));
        }),
        ...
        r.find("input").on("change", function () {
            var e = $(this);
            e.is(":checked")
                ? e.closest(".media").addClass("selected-row-bg")
                : e.closest(".media").removeClass("selected-row-bg");
        }),
        $(document).on(
            "change",
        ...
        i.find(".mail-delete").on("click", function () {
            r.find("input:checked").closest("li").remove(),
                ...
                0 == $(".email-user-list .users-list-wrapper li:visible").length
                    ? n.find(".no-results").addClass("show")
                    : n.find(".no-results").hasClass("show") &&
                      n.find(".no-results").removeClass("show");
        }),
        i.find(".mail-unread").on("click", function () {
            r.find("input:checked").closest("li").removeClass("mail-read"),
                i
                    .find(
                        ".user-action .checkbox-con input:checked , .selectAll input"
                    )
                    .prop("checked", "")
                    .closest(".media")
                    .removeClass("selected-row-bg");
        ...
        t.find("#email-search").on("keyup", function () {
            ...
            ($(".media").css("animation", "none"), "" != e)
                ? (n.find(".users-list-wrapper li").filter(function () {
                  ...
                  0 ==
                  $(".email-user-list .users-list-wrapper li:visible").length
                      ? n.find(".no-results").addClass("show")
                      : n.find(".no-results").hasClass("show") &&
                        n.find(".no-results").removeClass("show"))
                : (n.find(".users-list-wrapper li").show(),
                  n.find(".no-results").hasClass("show") &&
                      n.find(".no-results").removeClass("show"));
        }),
        ...
        $(".close-icon, .cancel-btn, .app-content-overlay").on(
            "click",
            function () {
                a.removeClass("show"),
                    s.removeClass("show"),
                    $("#compose-form").find("input").val(""),
                    ($(".custom-file .custom-file-label")[0].innerHTML =
                        "Attach File"),
