    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- @can('management_access') --}}
                <li class=" nav-item"><a href="#"><i class="{{ request()->is('backsite/permission') || request()->is('backsite/permission/*') || request()->is('backsite/*/permission') || request()->is('backsite/*/permission/*') || request()->is('backsite/role') || request()->is('backsite/role/*')
                 || request()->is('backsite/*/role') || request()->is('backsite/*/role/*') || request()->is('backsite/user') || request()->is('backsite/user/*') || request()->is('backsite/*/user') || request()->is('backsite/*/user/*') || request()->is('backsite/type_user') || request()->is('backsite/type_user/*') || request()->is('backsite/*/type_user') || request()->is('backsite/*/type_user/*') ? 'bx bx-group bx-flashing' : 'bx bx-group' }}">
                </i><span class="menu-title" data-i18n="Management Access">Management Access</span></a>
                    ...
                    <ul class="menu-content">
                        ...
                        {{-- @can('jenistiket_access') --}}
                            <li class="{{ request()->is('backsite/jenistiket') || request()->is('backsite/jenistiket/*') || request()->is('backsite/*/jenistiket') || request()->is('backsite/*/jenistiket/*') ? 'active' : '' }} ">
                                <a class="menu-item" href="{{ route('backsite.jenis-tiket.index') }}">
            ...
            {{-- @can('operational_access') --}}
                <li class=" nav-item"><a href="#"><i class="{{ request()->is('backsite/event') || request()->is('backsite/event/*') || request()->is('backsite/*/event') || request()->is('backsite/*/event/*') || request()->is('backsite/hospital_patient') || request()->is('backsite/hospital_patient/*') || request()->is('backsite/*/hospital_patient') || request()->is('backsite/*/hospital_patient/*')
                || request()->is('backsite/ticket') || request()->is('backsite/ticket/*') || request()->is('backsite/*/ticket') || request()->is('backsite/*/ticket/*') || request()->is('backsite/transaction') || request()->is('backsite/transaction/*') || request()->is('backsite/*/transaction') || request()->is('backsite/*/transaction/*') ? 'bx bx-hive bx-flashing' : 'bx bx-hive' }}">
                </i><span class="menu-title" data-i18n="Operational">Operational</span></a>
                    <ul class="menu-content">

                        {{-- @can('event_access') --}}
                            <li class="{{ request()->is('backsite/event') || request()->is('backsite/event/*') || request()->is('backsite/*/event')
                            || request()->is('backsite/*/event/*') ? 'active' : '' }} ">
