                                                    ...
                                                    <tbody>
                                                        @forelse($transaction as $key => $transaction_item)
                                                            <tr data-entry-id="{{ $transaction_item->id }}">
                                                                ...
                                                                <td>{{ $transaction_item->ticket->event->name ?? '' }}</td>
                                                                <td>{{ $transaction_item->ticket->user->name ?? '' }}</td>
                                                                <td>{{ 'IDR '.number_format($transaction_item->price_event) ?? '' }}</td>
                                                                ...
                                                                <td>{{ 'IDR '.number_format($transaction_item->pajak) ?? '' }}</td>
