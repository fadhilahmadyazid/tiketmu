                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.event.store') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <tbody>
                                                        @forelse($event as $key => $event_item)
                                                            <tr data-entry-id="{{ $event_item->id }}">
                                                                <td>{{ isset($event_item->created_at) ? date("d/m/Y H:i:s",strtotime($event_item->created_at)) : '' }}</td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('event_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.event.edit', $event_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan

                                                                            @can('event_delete')
                                                                                <form action="{{ route('backsite.event.destroy', $event_item->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
